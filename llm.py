...
class LLM:
    ...
    def build_system_prompt(self, ibkr_summary):
        return (
            ...
            f"Quantity for BUY is 2 unless specified. Quantity for SELL is 1 unless specified closed all, out of the rest, sl to be means sell rest of the contracts "
            ...
            f"If no symbol is explicitly mentioned in the message and there is more than one open position, you must return: symbol: N/A, contract_type: N/A, expiry: N/A, strike: N/A, action: SPECULATE, quantity: N/A. Only infer the symbol if there is exactly one open position"
...
llm=LLM()
print(llm.prompt("IBKR positions summary: [long TSLA 350C 7/18] ,USER MESSAGE: personally going to add here with mental stop under level mentioned"))
